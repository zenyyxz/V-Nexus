        ...
        .run(|app_handle, event| {
            match event {
                ...
                tauri::RunEvent::WindowEvent {
                    ...
                    // Prevent app verification from exiting, just hide window
                    // (Unless specifically quitting via Tray/Code)
                    // Note: Currently just hides. If we want true "Quit", we use app.exit() which triggers ExitRequested
